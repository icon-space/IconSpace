import { ISvgAttr, ISvgElementInfo, ISvgInfo, ISvgInlineStyleAttr, ISvgStyleAttr, ISvgStyleKeyframesInfo, ISvgStyleRuleInfo, ISvgStyleSelector, SvgTags } from './types'
...
// 标签名
// 支持用*表示全部
export interface ITransformPlugin extends Partial<Record<SvgTags, Partial<ITransformPluginItem>>>, Partial<ITransformProgramPluginItem> {
...
export class Transformer {
    ...
    private processStyleRuleSelector(selector: ISvgStyleSelector[][], rule: ISvgStyleRuleInfo, plugins: IRuleTransformPluginItem[]): ISvgStyleSelector[][] | null {
    ...
    private processStyleRuleSelectorList(selector: ISvgStyleSelector[], rule: ISvgStyleRuleInfo, plugins: IRuleTransformPluginItem[]): ISvgStyleSelector[] | null {
        const list: ISvgStyleSelector[] = []
    ...
    private processStyleRuleSelectorItem(selector: ISvgStyleSelector, rule: ISvgStyleRuleInfo, plugins: IRuleTransformPluginItem[]): ISvgStyleSelector | null {
        // 执行属性变换
        for (const plugin of plugins) {
