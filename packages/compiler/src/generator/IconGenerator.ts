...
import { ISvgInfo, ISvgStyleAttr, ISvgStyleInfo, ISvgStyleKeyframesInfo, ISvgStyleRuleInfo, ISvgStyleSelector, SvgShapeAttr, SvgStyleSelectorType } from '../types'
...
export abstract class IconGenerator extends Generator {
    ...
    protected processStyleKeyframe(rule: ISvgStyleKeyframesInfo): void {
        ...
        this.writeLine(`@${name} ${selector.type === SvgShapeAttr.CONST ? selector.expression : '${' + selector.expression + '}'} {`)
        this.indent(1)
