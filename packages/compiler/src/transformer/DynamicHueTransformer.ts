...
function converter<T extends ISvgAttr | ISvgInlineStyleAttr | ISvgStyleAttr>(options: IDynamicHueTransformerOptions, attr: T): T | null {
    const { prefix, propName, formatter = 'format', hueList, forceReplaceColor = false } = options
