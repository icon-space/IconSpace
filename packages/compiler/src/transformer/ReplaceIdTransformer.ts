...
import { IReplaceIdTransformerOptions, ISvgAttr, ISvgStyleAttr, ISvgStyleSelector, SvgShapeAttr, SvgStyleSelectorType } from '../types'
...
function replaceAttrIdTransformer<T extends ISvgAttr | ISvgStyleAttr>(attr: T, map: IReplaceIdTransformerOptions): T | null {
...
export function replaceSelectorIdTransformer(attr: ISvgStyleSelector, map: IReplaceIdTransformerOptions, targetSelectorType: SvgStyleSelectorType): ISvgStyleSelector | null {
