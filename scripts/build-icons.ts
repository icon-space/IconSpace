...
import { parse, CsvError, Info } from 'csv-parse'
...
parse(content, { delimiter: ',' }, function (err: CsvError | undefined, records: any | undefined, info: Info) {
    if (err) {
        throw err
    }
    const arr: string[][] = records
